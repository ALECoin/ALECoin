...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ALECoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"node.ale-coin.com", "node.ale-coin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ALECoin is probably already running."), addrBind.ToString().c_str());
        else
