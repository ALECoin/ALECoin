...
uint256 hashGenesisBlock("0x000006fd9b83d4243967adc6e7d2826dedbf2c27b6586d7bdac67250d2120b61");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // ALECoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "ALECoin Signed Message:\n";
...
{
    // ALECoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 1000 blocks
    nSubsidy >>= (nHeight / 1000); // ALECoin: 1000

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 24 * 60 * 60; // ALECoin: 1 day
static const int64 nTargetSpacing = 120; // ALECoin: 2 minute
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // ALECoin: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 120; // ALECoin: 2 minute
        static const unsigned int TimeDaySeconds = 24 * 60 * 60; // ALECoin: 1 day
...
{
    // ALECoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000006fd9b83d4243967adc6e7d2826dedbf2c27b6586d7bdac67250d2120b61");
    }
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "Ale Coin For All";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
 ...
 if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xd60daa8e8918d9318cc80af278034aab359bdbd35f0eb46e33b0dd25666c5887"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // ALECoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ALECoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ALECoinMiner : ProcessBlock, block not accepted");
    }
